...
namespace enseirb{ 
  ...
  template<class DataType, void (*freeFonction)(DataType*) = freeSimple>
  class SmartPointer{
    DataType *data;
    int *counter;
  ...
  template <typename T> using  SmartSimple = SmartPointer<T, freeSimple>;
  template <typename T> using  SmartArray = SmartPointer<T, freeArray>;

...
class Simple {
    ...
    static public void main (String[] args) throws tec.TecInvalidException, java.io.IOException{
	Transport serenity = tec.FabriqueTec.faireAutobusFichier(1,2, "fichier.txt");
	//Transport serenity = tec.FabriqueTec.faireAutobusMemoire(1,2);

...
class CollecteFichier implements Collecte{
    ...
    private int tmpEntrees; //Cet entier sert à afficher le nombre d'entrées au même moment que le nombre de sorties, et donc au bon moment, par rapport à la méthode debog du client.

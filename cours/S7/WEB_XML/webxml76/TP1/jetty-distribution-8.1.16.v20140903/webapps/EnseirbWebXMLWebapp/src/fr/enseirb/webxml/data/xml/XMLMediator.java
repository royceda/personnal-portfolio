gepackage fr.enseirb.webxml.data.xml;
...
public class XMLMediator {
	...
	if(XML.Toolkit.isXMLValid(tasksXML,"ressources/xsd/tasks.xsd" )){
	    LOGGER.log(Level.INFO, "XML Tasks are: " + tasksXML);
	    return "<good>ca marche</good>"; //synt
	}
	else 
	    return "<error>XML No valid</error>";
    }
	...
	if(XML.Toolkit.isXMLValid(taskXML,"ressources/xsd/tasks.xsd" )){
	    LOGGER.log(Level.INFO, "XML Task with id " + id + " is: " + taskXML);
	    return "<good>ca marche</good>";//taskXML;
	}
	else 
	    return "<error>erreur de xml</error>";
    }
